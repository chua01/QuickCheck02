...
@section('content')
    ...
    <div class="container-fluid py-4">
        <form method="POST" action="{{ route('purchaseorder.updateOrderInfo2', ['id' => $purchaseorder->id]) }}">
            @csrf
            <div class="row">
                <div class="col-md-12">
                                ...
                                <div class="col-auto" id="extrafee">
                                    <div class="input-group">
                                        ...
                                        <input name="extrafee" style="text-align: right;" type="number"
                                            class="form-control no-border-bottom" placeholder="" onchange="update_item_info()" value="{{$purchaseorder->extra_fee}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-auto" id="discount">
                                    <div class="input-group">
                                        ...
                                        <input name="discount" style="text-align: right;" type="number"
                                            class="form-control no-border-bottom" placeholder="" onchange="update_item_info()" value="{{$purchaseorder->discount}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row my-1">
