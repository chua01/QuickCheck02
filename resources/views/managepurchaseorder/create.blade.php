...
@section('content')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="checkbox" id="existingsupplier" name="existingsupplier"
                                                    value="1">
                                                <label for="checkboxName">Existing supplier</label>
                                            </div>
                                            <div id="supplierForm" style="display: none;">
                                                <input class="form-control no-border-bottom" type="text"
                                                    ...
                                                    onchange="update_supplier_info(this.value)" />
    ...
    <script>
        ...
        document.getElementById('existingsupplier').addEventListener('change', function() {
            ...
            var supplierFrom = document.getElementById('supplierForm');

            console.log(name.value)
            if (this.checked) {
                supplierFrom.style.display = 'block';
                supplierFrom.querySelector('input').value = '';
                name.disabled = true;
                email.disabled = true;
                ...
                supplierFrom.style.display = 'none';
                // Make fields editable when existing supplier is not selected
                name.disabled = false;
    ...
    <script>
        ...
        function update_supplier_info(id) {
            ...
            id = id - 1;
            name.value = suppliers[id]['name'];
            console.log(name.value + suppliers[id]['name'] + name);
            email.value = suppliers[id]['email'];
            contactno.value = suppliers[id]['contact'][0]['contactnumber'];
            location.value = suppliers[id]['address']['location'];
            code.value = suppliers[id]['address']['code'];
            street.value = suppliers[id]['address']['street'];
            state.value = suppliers[id]['address']['state'];
        }
