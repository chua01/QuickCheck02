                        ...
                        <div class="card-header pb-0">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-auto">
                                    ...
                                    <a href="{{route('supplier.show', ['id'=>$purchaseorder->supplier_id])}}" class="btn btn-info btn-sm ms-auto">Back</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                            ...
                                            <table class="table table-borderless mb-0">
                                                <tbody class="text-start">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-start">{{ number_format($purchaseorder->amount / 1.06, 2) }}</td>
                                                    </tr>
                                                    <tr>
