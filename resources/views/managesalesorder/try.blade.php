...
@section('content')
    ...
    <div class="container-fluid py-4">
        <form method="POST" action="{{ route('trysee2') }}">
            @csrf
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <div class="d-flex px-3 py-1">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <p id="itemName0" class="text-sm mb-0 h6"></p>
                                                        <input id="itemId0" class="form-control no-border-bottom"
                                                            type="text" placeholder="Enter item" value="23"
                                                            list="itemslist0" name="orderitem[0][id]" />
                                            ...
                                            <td>
                                                <input type="text" class="form-control no-border-bottom"
                                                    placeholder="0.00" value="" name="orderitem[0][price]">
                                            ...
                                            <td>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-4">
                                                        <p id="itemUnit0" class="text-sm mb-0 h6"></p>
    ...
    <script>
            ...
            newDropdown.innerHTML = `
                    <tr>
                                                    <td>
                                                        ...
                                                        <div class="d-flex px-3 py-1">
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <p id="itemName${index}" class="text-sm mb-0 h6"></p>
                                                                <input id="itemId${index}" class="form-control no-border-bottom"
                                                                    type="text" placeholder="Enter item" value=""
                                                                    list="itemslist${index}" name="orderitem[${index}][id]"/>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-4">
                                                                <p id="itemUnit${index}" class="text-sm mb-0 h6"></p>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            for (var i = 0; i <= index; i++) {
                ...
                window['itemName' + i] = document.getElementById('itemName' + i);
                itemName = window['itemName' + i];
                window['itemIdInput' + i] = document.getElementById('itemId' + i);
                itemIdInput = window['itemIdInput' + i];
                window['itemsList' + i] = document.getElementById('itemslist' + i);
                itemsList = window['itemsList' + i];


                window['itemIdInput' + i].addEventListener('input', function(e) {
                    console.log(i + ' loop: ' + itemName);
                    console.log(i + ' loop: ' + itemIdInput);
                    console.log(i + ' loop: ' + itemsList);
                    ...
                    if (option) {
                        ...
                        if (optionParts[1]) {
                            window['itemUnit' + i] = document.getElementById('itemUnit' + i);
                            itemUnit = window['itemUnit' + i];
                            // var itemUnit = document.getElementById('itemUnit' + i);
                            if (itemUnit) {
